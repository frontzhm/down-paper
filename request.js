...
async function getPapersList(params = {}, cookies = 'gr_user_id=f5bbcce9-7b86-48d5-b270-67c04aaa6621; XDFUUID=db0b0bd2-6407-b293-514e-fc4984c6c284; email=zhanghuimin61%40xdf.cn; nickname=%E5%BC%A0%E6%85%A7%E6%95%8F; staffToken=emhhbmdodWltaW42MWVmMjEwYjJlLTM0Y2YtNDcxZS1hZDU3LTIzZTYyOWUyNzJjMw==; jsessionid=227c68cc-95fe-42c3-a0cb-92dda0fcb18e; rem=on; e2e=DCB2A892933AF3582BA5A72F10828894; e2mf=068a62e2555c4d62b08d3603302acfe8; wpsUserInfo={%22useId%22:%22408aea3f921d4edf9e14dcacf3537bf6%22%2C%22nickName%22:%22%E5%88%98%E4%B8%B9%E5%A6%AE%22%2C%22name%22:%22%E5%88%98%E4%B8%B9%E5%A6%AE%22%2C%22email%22:%22liudanni7@xdf.cn%22}; ac5caea5d6c36013_gr_session_id=66842db4-b247-42a1-842d-6eb9cbf90187; ac5caea5d6c36013_gr_session_id_sent_vst=66842db4-b247-42a1-842d-6eb9cbf90187') {
  ...
  // 默认cookies（如果没有传入cookies参数）
  const defaultCookies = [
    'gr_user_id=f5bbcce9-7b86-48d5-b270-67c04aaa6621',
    'XDFUUID=db0b0bd2-6407-b293-514e-fc4984c6c284',
    'email=zhanghuimin61%40xdf.cn',
    'nickname=%E5%BC%A0%E6%85%A7%E6%95%8F',
    'staffToken=emhhbmdodWltaW42MWVmMjEwYjJlLTM0Y2YtNDcxZS1hZDU3LTIzZTYyOWUyNzJjMw==',
    'jsessionid=227c68cc-95fe-42c3-a0cb-92dda0fcb18e',
    'rem=on',
    'e2e=DCB2A892933AF3582BA5A72F10828894',
    'e2mf=068a62e2555c4d62b08d3603302acfe8',
    ...
    'ac5caea5d6c36013_gr_session_id=66842db4-b247-42a1-842d-6eb9cbf90187',
    'ac5caea5d6c36013_gr_session_id_sent_vst=66842db4-b247-42a1-842d-6eb9cbf90187'
  ];
  ...
  if (cookies) {
    ...
    if (Array.isArray(cookies) && cookies.length > 0 && typeof cookies[0] === 'object' && cookies[0].name) {
      ...
      // 使用默认cookies
      cookieString = defaultCookies.join('; ');
    }
  } else {
    // 使用默认cookies
    cookieString = defaultCookies.join('; ');
...
const createLinkArr = (papersData) => {
  ...
  return papersData.map(createLink);
}
// 使用示例
async function main() {
  try {
