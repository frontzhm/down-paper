 ...
 * @param {string} options.queryParams.useScene - 使用场景（默认：null）
 * @param {string} options.queryParams.grade - 年级（默认：null）
 * @param {number} options.queryParams.quarter - 学期（默认：null）
