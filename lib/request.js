  ...
  return new Promise((resolve, reject) => {
    ...
    const requestOptions = {
      ...
      headers: {
        ...
        'origin': 'https://iteach-cloudwps.df.cn',
        'referer': 'https://iteach-cloudwps.df.cn/',
...
async function getPapersList(params = {}, cookies) {
  ...
  const url = `https://iteach-content-management-api.df.cn/api/papers?${queryString}`;
...
const createLinkArr = (papersData) => {
  const createLink = item => {
    ...
    return `https://iteach-cloudwps.df.cn/paperEditor?${params.toString()}`;
  }
...
async function main() {
  try {
    ...
    // 示例2: 传入自定义cookies字符串
    console.log('\n=== 使用自定义cookies字符串 ===');
    const customCookies = 'gr_user_id=f5bbcce9-7b86-48d5-b270-67c04aaa6621; dfUUID=db0b0bd2-6407-b293-514e-fc4984c6c284; e2mf=068a62e2555c4d62b08d3603302acfe8';
    ...
    console.log('\n=== 使用对象数组格式cookies ===');
    const cookies = [
      { name: 'gr_user_id', value: 'f5bbcce9-7b86-48d5-b270-67c04aaa6621', domain: '.df.cn' },
      { name: 'dfUUID', value: 'db0b0bd2-6407-b293-514e-fc4984c6c284', domain: '.df.cn' },
      { name: 'e2mf', value: '068a62e2555c4d62b08d3603302acfe8', domain: '.df.cn' }
    ];
